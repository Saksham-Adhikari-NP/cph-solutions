...
void solve () 
{
  ...
  int sum = 0;
    ...
    //  // brackets can always form a viable org so sum will never be negative :: 
  //  only insert starter when nothing else is there , 
   // (()) for seq ijkl ; 
  // 2 ( j-i) > 0  // closing the last open seq is always better 
