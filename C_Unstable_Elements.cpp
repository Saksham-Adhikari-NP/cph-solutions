...
void solve () 
{
    ...
    map<int,int> exact;      // exactly this frequency occurs this many times ;;
    ...
    Unique(freq) ;
     // unique occuring sorted frequency ;;; // occurence[x] -> how many times x or greater element occurs ;;
